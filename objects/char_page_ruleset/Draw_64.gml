...
draw_text_color(115, 300, data.variables.max_hp, c_white, c_white, c_white, c_white, 1)
draw_sprite(atk_icon, 1, 150, 300)
draw_text_color(215, 300, data.variables.basic_attack, c_white, c_white, c_white, c_white, 1)
draw_sprite(rang_icon, 1, 50, 348)
draw_text_color(115, 348, data.variables.basic_range, c_white, c_white, c_white, c_white, 1)
draw_sprite(atk_speed_icon, 1, 150, 348)
draw_text_color(215, 348, data.variables.attack_interval / 60, c_white, c_white, c_white, c_white, 1)
draw_sprite(accuracy_icon, 1, 50, 396)
draw_text_color(115, 396, data.variables.basic_accuracy, c_white, c_white, c_white, c_white, 1)
draw_sprite(dodge_icon, 1, 150, 396)
draw_text_color(215, 396, data.variables.dodge_chance, c_white, c_white, c_white, c_white, 1)
draw_sprite(crit_chance_icon, 1, 50, 444)
draw_text_color(115, 444, data.variables.basic_crit_chance, c_white, c_white, c_white, c_white, 1)
draw_sprite(crit_damage_icon, 1, 150, 444)
draw_text_color(215, 444, data.variables.basic_crit_damage, c_white, c_white, c_white, c_white, 1)
draw_sprite(speed_icon, 1, 50, 492)
draw_text_color(115, 492, data.variables.mov_speed, c_white, c_white, c_white, c_white, 1)
draw_sprite(sanity_icon, 1, 150, 492)
draw_text_color(215, 492, data.variables.max_sanity, c_white, c_white, c_white, c_white, 1)
}
else{
