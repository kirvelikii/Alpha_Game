...
if position_meeting(mouse_x, mouse_y, self) and inv_ruleset.drag_obj == noone{
    if mouse_x >= room_width / 2{
        ...
        draw_text_color(x - 200, y + 64, reff.variables.hp, c_white, c_white, c_white, c_white, 1)
        ...
        draw_text_color(x+128 + 100, y + 64, reff.variables.hp, c_white, c_white, c_white, c_white, 1)
