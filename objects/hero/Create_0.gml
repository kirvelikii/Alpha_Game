if !variable_global_exists("nicknames") or array_length(global.nicknames) == 0{
    global.nicknames = [
    "Александр", "Дмитрий", "Сергей", "Андрей", "Алексей", 
    "Артем", "Илья", "Кирилл", "Михаил", "Егор",
    "Матвей", "Роман", "Владимир", "Ярослав", "Тимофей",
    "Арсений", "Денис", "Владислав", "Павел", "Глеб",
    "Константин", "Богдан", "Евгений", "Никита", "Иван",
    "Даниил", "Виктор", "Степан", "Олег", "Игорь",
    "Максим", "Николай", "Артур", "Георгий", "Леонид",
    "Петр", "Василий", "Марк", "Федор", "Семен",
    "Юрий", "Давид", "Лев", "Станислав", "Вадим",
    "Ибрагим", "Руслан", "Эдуард", "Григорий", "Захар",
    "Данила", "Тимур", "Антон", "Герман", "Святослав",
    "Валерий", "Савелий", "Платон", "Родион", "Прохор",
    "Всеволод", "Мирон", "Вячеслав", "Борис", "Филипп",
    "Демид", "Савва", "Елисей", "Анатолий", "Аркадий",
    "Марат", "Эльдар", "Ян", "Роберт", "Альберт",
    "Архип", "Виталий", "Гордей", "Зураб", "Игнат",
    "Камиль", "Лука", "Назар", "Остап", "Рамиль",
    "Серафим", "Тарас", "Умар", "Харитон", "Шамиль",
    "Эмиль", "Юлиан", "Яков", "Адам", "Адриан",
    "Альфредо", "Амир", "Арно", "Бенедикт", "Владлен", "Егор Андреич",
    "Эрик", "Годжо", "Киривелик"
];
}
